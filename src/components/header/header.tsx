...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 bg-background dark:bg-foreground dark:text-background w-full z-30 p-4 shadow-lg dark:shadow-lg border-none border-gray-200 dark:border-gray-700">
